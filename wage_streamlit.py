...
# 全国と都道府県の一人当たり賃金比較グラフ

st.header('■集計年別の一人当たり平均賃金の推移')

df_ts_mean = df_jp_ind[(df_jp_ind['年齢']=='年齢計')]
df_ts_mean = df_ts_mean.rename(columns={'一人当たり賃金（万円）' : '全国＿一人当たり賃金'})
...
df_mean_line = df_mean_line[['集計年','全国＿一人当たり賃金','一人当たり賃金（万円）']]
df_mean_line = df_mean_line.set_index('集計年')

st.line_chart(df_mean_line)

# 年齢別階級別の平均賃金のバブルチャート　集計年ごとに切り替え
...
st.text('本結果は、RESASによるデータの加工・加工結果の表示により作成されたものです。')
